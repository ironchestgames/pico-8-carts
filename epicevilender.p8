 ...
 for i=1,3 do
  for _y=1,14 do
   for _x=1,14 do
    ...
    if _col == 1 and c == 0 then
     sset(_x,_y+64,0)
    elseif _col == 0 and c >= 7 then
     sset(_x,_y+64,1)
    end
   end
  end
...
function _update60()
 ...
 if enemycount == 0 then
  floormap[exitdoor.y/8][exitdoor.x/8]=0
...

...

