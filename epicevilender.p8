...
swordattackskill={
 ...
 update=function(skill,user)
  ...
  if skill.hasinput and skill.counter <= 0 then
   ...
   -- add vfx
   angletofx={
    [0]={0,20,4,7, -2,-5}, -- right
    [0.125]={8,20,6,4, -3,-3}, -- right/up
    [0.25]={20,20,9,3, -4,-2}, -- up
    [0.375]={14,20,6,4, -3,-3}, -- up/left
    [0.5]={4,20,4,7, -2,-5}, -- left
    [0.625]={29,20,4,7, -3,-4}, -- left/down
    [0.75]={20,23,9,3, -4,-1}, -- down
    [0.875]={33,20,4,7, -1,-4}, -- down/right
   }
