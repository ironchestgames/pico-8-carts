...
function gameupdate()
 ...
 -- game over cleanup
 if gameover then
  sfx(-2,3) -- stop running sound loop
  handler.iscalling=false
...
function instructionsdraw()
 ...
 if currentpage == 1 then
  ...
  print('     instructions 1/4\n\n\n')
  print('this is dog agility!\n')
  print('play against your friends')
  print('on 15 different courses,')
  print('or play one player and try')
  print('to beat your fastest run!\n')
  print('multiplayer support through')
  print('hot seat\n')

 elseif currentpage == 2 then
  
  print('     instructions 2/4\n\n\n')
  print(' first: select players and')
  print('        dogs (there are no')
  print('        cpu players)\n')
  print('second: select course\n')
  print(' third: play!')
 ...
 elseif currentpage == 3 then
  ...
  print('     instructions 3/4\n\n\n')
  print('\x8b\x91\x94\x83 - move, send-aim\n')
  print('  \x8e (z) - call dog to')
  print('           follow you\n')
  print('  \x97 (x) - send dog to')
  print('           clear obstacle')

 -- tips
 elseif currentpage == 4 then

  print('     instructions 4/4\n\n\n')
  print('           tips\n')
  print('your dog needs to be within')
  print('handling range to be sent')
  print('through an obstacle.\n')
  print('the dogs differ in speed')
  print('and handling range, find')
  print('your favourite!')

 end

 print('\x97 back       \x8b \x91 change page',3,121,7)
...
function playersetupdraw()
 ...
 -- draw done button
 local donestr='done'
 print(donestr,57,offy+40,11)

 -- draw instructions text
 local instructionstr='instructions'
 print(instructionstr,41,offy+54,11)
 ...
 if menuy < 3 then
  ...
  local _offy=offy+36+(menuy-3)*14
  rect(offx,_offy,offx+16*4,_offy+12,col)
  if menuy == 3 then
   print(donestr,57,offy+40,col)
  elseif menuy == 4 then
   print(instructionstr,41,offy+54,col)
  end
 end
...
function _update60()
 ...
 elseif scene == instructionsupdate then
  instructionsupdate()
  _draw=instructionsdraw
 end
end
...

...

...

...
001000201f0201f0211f0211f02500000002100c210002101d0201d0211d0221d0250000000000180200c7301c0201c0211c0211c0250000200000180200c7301d0201d0211d0221c0201c0201a0201a01500002
__music__
01 00014344
02 000d4344
01 00010a44
