...
function gameupdate()
 ...
 -- tick timers
 dog.exclamationcounter-=1
 dog.questioncounter-=1
 ...
 handler.a=getangle(
   ...
   handlerycomp)
 handler.spd=spd
 handler.callcounter-=1

 -- set handling pos
 if handlerxcomp != 0 or
    handlerycomp != 0 then
  handler.handlingx=handler.x+cos(handler.a)*10
  handler.handlingy=handler.y+sin(handler.a)*10
 else
 ...
 -- call to follow
 if btn(4) then
  handler.callcounter=70
 end

 if handler.callcounter > 0 and
    (dog.state == state_totarget or
     dog.state == state_follow or
     dog.state == state_idle) and
    distance(
     handler.x,
     handler.y,
     dog.x,
 ...
 if btn(5) then
  ...
  handler.callcounter=0

  -- only if dog is not doing anything else
  if dog.state != state_totarget and
     dog.state != state_clearing then
   local sendarea=nil

   -- first test handling pos
   ...
   -- try handler pos if no sendarea found
  ...
  if isinsiderotatedrect(
   ...
   elseif dog.targetentry.obstacle == obstacle_slalom then
    ...
    for i=0,7 do
     ...
     local _h=3
     if i == 7 then
      _h=8 -- note: get out of disq zone on last pos
     end
...
function gamedraw()
 ...
 if handler.callcounter > 40 then
  local frame=12
  if handler.callcounter%12 < 6 then
   frame=13
  end
  spr(
    frame,
 ...
 if debugdraw == true then
  ...
  for d in all(drawthese) do
   if d[1] == circ then
    circ(d[2],d[3],d[4],d[5])
   end
  end
 end
...
-- todo: remove, this is dev only
-- coursesummary={
--  {
--   player=playerconfs[1],
--   coursetime=1234,
--  },
--  {
--   player=playerconfs[2],
--   coursetime=2344,
--  },
--  {
--   player=playerconfs[3],
--   coursetime=988,
--  },
--  {
--   player=playerconfs[4],
--   disqualified=true,
--  },
-- }
...
function playersetupdraw()
 ...
 for playerconf in all(playerconfs) do
  ...
  spr(breeds[playerconf.dog].sprstart,_x+5,_y+5)
  pal()
 ...
 if menuy < 3 then
  ...
  local _offy=offy+38
  rect(offx,_offy,offx+16*4,_offy+12)
  print(donestr,58,offy+42)
 end
...
function courseselectiondraw()
 ...
 local besttime=dget(courses[currentcourseidx].coursenr)
 local s='--:--.--'
 if besttime != 0 then
  s=ticktotimestr(besttime)
 end
...

...

__label__
...
__sfx__

