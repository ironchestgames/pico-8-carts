...
--]]
local doortypopened=s2t'.14;15;.18;20;.19;20;'
local doortypclosed=s2t'.15;14;.20;19;'
...
function mapgen()
 ...
 -- add trees
 -- todo: change all floor tests to be floor[_i] >= 2, and see if it is possible to add trees as '3'
 -- for _i=0,6 do
 --  local treex,treey=flr(rnd(32)),flr(rnd(32))
 -- end
...
-- add objects
 ...
 for _i in all(_pos) do
  ...
  elseif _typ == 7 then
   ...
   objs[_iplus1]={typ=8,action={[0]=soundaction,nil,camcontrol},shadow={}}
   objs[_i+2]={typ=9,shadow={true}}
  ...
  elseif _typ == 10 then
   ...
   objs[_iplus1]={typ=11,shadow={true}}
 ...
 for _x=2,29 do
  for _j=1,3 do
   ...
   if not (objs[_i] or
    ...
    local _o={typ=_typ,shadow={nil,true,true}} -- todo: fix
    objs[_i]=_o
   end
  end
 end
...

__sfx__
